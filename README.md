...
The Python script, that does the real work, was written by Damjan Georgievski and contributed to the Avahi wiki in 2006. There is no statement there as to any specific license and it has been incorporated into many projects (see later) that have been released under various different licenses. I've emailed Damjan about this.
